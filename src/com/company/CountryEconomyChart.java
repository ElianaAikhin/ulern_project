...
public class CountryEconomyChart extends JFrame{
    public CountryEconomyChart(Map<String, Float> data){
        initUI(data);
    }
    ...
    private SlidingCategoryDataset createDataset(Map<String, Float> data){
        ...
        for (String key : data.keySet())
            dataset.setValue(data.get(key), "Economy", key);
